Congratulations, you are now the lead investigator and administrator of your very own [Gatelight](http://www.discourse.org) investigation. :hatching_chick:

### Getting Started

If you haven't already, launch the [setup wizard](/wizard) and go through the steps to configure this site. You can run the wizard as many times as you want, it's completely safe!
...
### Admins, Moderators and Everyone Else

If you want, you can invite different levels of collaborators.

Admins (like you) and moderators have official functions administering this website.

1. **Admins** can do anything and configure anything on this site.
2. **Moderators** can edit all posts and users, but cannot add categories or change any site settings.

To add admins or moderators:
...
Note that pinning topics does work a little differently in Gatelight:
...
Note that all new users will be granted trust level 1 until the investigation includes 50 collaborators.

### Sending Invitations

You can invite people to join your investigation via:
...
For more assistance on configuring and running Gatelight forum, simply ask Jackson by tagging him in a conversation: @jackson. Alternatively, send him an email at jackson@gatelight.org.
